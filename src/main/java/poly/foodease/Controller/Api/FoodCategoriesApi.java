...
public class FoodCategoriesApi {
    ...
    @PostMapping
    public FoodCategoriesReponse createCategories(@RequestBody FoodCategoriesRequest foodCategoriesRequest){
        return foodCategoryService.createCategories(foodCategoriesRequest);
    }
