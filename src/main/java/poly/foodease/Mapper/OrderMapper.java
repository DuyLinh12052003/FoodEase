    ...
    public OrderResponse convertEnToRes(Order order){
        ...
        public Order convertReqToEn(OrderRequest orderRequest){
            return Order.builder()
                    .orderDate(orderRequest.getPaymentDate() != null ? orderRequest.getPaymentDate() : LocalDate.now())
                    .orderTime(orderRequest.getPaymentTime() != null ? orderRequest.getPaymentTime() : LocalTime.now())
...
//                                    )
        ...
        public OrderRequest convertResToReq(OrderResponse orderResponse){
            return OrderRequest.builder()
                    ...
                    .paymentDate(orderResponse.getPaymentDate())
                    .paymentTime(orderResponse.getPaymentTime())
                    .userId(orderResponse.getUser().getUserId())
                    .couponId(orderResponse.getCoupon().getCouponId())
