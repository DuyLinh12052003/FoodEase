      ...
      <div className="food-details">
        <div className="food-info">
          <div className="food-image">
            ...
            {foodDetail.quantityStock === 0 && (
              <span className="out-of-stock">{customTranslate("OUT OF STOCK")}</span>
            )}
        ...
        <div className="details">
          ...
          <div className="nutrition">
            <h3>{customTranslate("Sold")}:{foodDetail.quantityStock}</h3>
            <p>Proteins: 2.2, Carbs: 14.4, {customTranslate("Fats")}: 1.2, {customTranslate("Total")} Kcal: 157.8</p>
          </div>
          <div className="">
          ...
          >
            {customTranslate(foodDetail.quantityStock ? "order" : "out of stock")}
          </button>
        </div>
      </div>
          ...
          {propose.slice(0, 3).map((item) => (
            <div key={item.foodVariationId} className="">
              <div className="image-discount">
                ...
                <div className="disscount1">{customTranslate("Discount")}:{item.food.discount}%</div>
              </div>
