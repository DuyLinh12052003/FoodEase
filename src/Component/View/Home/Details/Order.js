    ...
    <div className="modal">
      <div className="modal-content">
        ...
        <div className="image-container">
          ...
          />
          <div className="disscount2">{customTranslate("Discount")}:{product.food.discount}%</div>
        </div>
        {/* nếu số lượng = 0 thì sẻ hiển thị  */}

        {foodVariation && foodVariation.quantityStock === 0 && (
          <span className="out-of-stock1">{customTranslate("OUT OF STOCK")}</span>
        )}
        ...
        <div className="options">
          <div className="size-options">
            ...
            {TableFoodSize.map((foodSize) => (
              <div key={foodSize.foodSizeId}>
                <input
                  ...
                  defaultChecked={
                    foodSize.foodSizeName === product.foodSize.foodSizeName
                  }
                />
            ...
            <br />
            {foodVariation && <h4>{customTranslate("Sold")}:{foodVariation.quantityStock}</h4>}
          </div>
            ...
            <div className="topping-options">
              ...
              {FoodVariationgTopping.map((topping) => (
                <div key={topping.toppingId}>
                  ...
                  <span>{topping.toppings.price.toLocaleString("vi-VN")}</span>
                </div>
              ))}
            </div>
          )}
